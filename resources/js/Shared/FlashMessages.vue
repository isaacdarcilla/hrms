<template>
  <div>
    <div
      ...
      class="mb-8 flex items-center justify-between bg-green-500 rounded-lg"
    >
      <!-- <div
        class="absolute flex max-w-xs w-full mt-4 r-4 top-0 right-0 bg-green-500 rounded-lg shadow p-4"
      >
        <div class="mr-2">
          <svg
            class="w-6 h-6"
        ...
        <div class="ml-2">
          <button type="button" class="group mr-2 p-2" @click="show = false">
            <svg
              class="block w-2 h-2 fill-white group-hover:fill-green-800"
              xmlns="http://www.w3.org/2000/svg"
              width="235.908"
              height="235.908"
    ...
    <div
      ...
      class="mb-8 flex items-center justify-between bg-red-500 rounded-lg"
    >
      <div class="flex items-center">
        <svg
          class="ml-4 mr-2 flex-shrink-0 w-4 h-4 fill-white"
      ...
      <button type="button" class="group mr-2 p-2" @click="show = false">
        <svg
          class="block w-2 h-2 fill-white group-hover:fill-red-800"
          xmlns="http://www.w3.org/2000/svg"
          width="235.908"
          height="235.908"
          viewBox="278.046 126.846 235.908 235.908"
