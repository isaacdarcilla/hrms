                ...
                <form @submit.prevent="save" class="w-full max-w-lg pr-4 pt-5">
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        v-model="form.name"
                      />
                      <div v-if="$page.errors.name !== null" class="form-error">
                        {{ $page.errors.name }}
                      </div>
                    </div>
                  </div>
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      />
                      <div v-if="$page.errors.address !== null" class="form-error">
                        {{ $page.errors.address }}
                      </div>
                    </div>
                  </div>
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      <label class="form-label font-bold"
                        >Telephone Number<span class="text-red-600">*</span></label
                      >
                      <input
                        autofocus="true"
                        class="form-input block w-full"
                      ...
                      />
                      <div v-if="$page.errors.telephone_number !== null" class="form-error">
...
export default {
  ...
  methods: {
    save() {
      this.$inertia.post(this.route("reference.store"), this.form, {
