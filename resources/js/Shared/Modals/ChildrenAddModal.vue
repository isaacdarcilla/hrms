		            ...
		            <form class="w-full max-w-lg pr-4 pt-5">
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
							    ...
							    <input autofocus="true" class="form-input block w-full"placeholder="Enter child name" 
			            ...
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
							    ...
							    <input ref="birthday" class="form-input block w-full"placeholder="Enter child birthday" type="tel" v-mask="'##/##/####'"
