                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        v-model="form.children_name"
                        ref="name"
                      />
                      <div
                        v-if="$page.errors.children_name !== null"
                        class="form-error"
                      >
                        {{ $page.errors.children_name }}
                      </div>
                    </div>
                  </div>
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <div
                        ...
                        class="form-error"
                      >
                        {{ $page.errors.children_birth_date }}
                      </div>
                    </div>
                  </div>
                </form>
...
export default {
  ...
  methods: {
    save() {
      this.$inertia.post(
        this.route("children.store", [
          this.background.contact_id,
          this.background.id,
        ]),
        this.form,
        {
