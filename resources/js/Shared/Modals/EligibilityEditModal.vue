            ...
            <div>
              <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  ✏️ Edit {{ employeeId.first_name }} Civil Service Eligibility
                </h3>
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        :placeholder="eligibility.eligibility_name"
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ref="birthday"
                        class="form-input block w-full"
                        :placeholder="eligibility.eligibility_place_of_exam"
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        class="form-input block w-full"
                        :placeholder="
                          eligibility.eligibility_rating === null
                            ? `Enter rating or score`
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        class="form-input block w-full"
                        :placeholder="
                          eligibility.eligibility_license_number === null
