            ...
            <div>
              <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  ✏️ Edit {{ employeeId.first_name }} Work Experience
                </h3>
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        :placeholder="experience.experiences_company"
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        class="form-input block w-full"
                        :placeholder="
                          experience.experiences_monthly_salary === null
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        class="form-input block w-full"
                        :placeholder="
                          experience.experiences_salary_grade === null
                            ? `Enter salary grade`
