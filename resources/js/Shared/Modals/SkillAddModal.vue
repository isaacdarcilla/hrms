            ...
            <div>
              <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  ➕ Add Special Skills and Hobbies
                </h3>
                <form @submit.prevent="save" class="w-full max-w-lg pr-4 pt-5">
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      <label class="form-label font-bold">Name of Skill <span class="text-red-600">*</span></label>
                      <input
                        autofocus="true"
                        class="form-input block w-full"
                        placeholder="Enter skill or hobby name"
                        v-model="form.skills_name"
                      />
                      <div
                        v-if="$page.errors.skills_name !== null"
                        class="form-error"
                      >
                        {{ $page.errors.skills_name }}
                      </div>
                    </div>
                  </div>
                </form>
...
export default {
  ...
  methods: {
    save() {
      this.$inertia.post(this.route("skill.store"), this.form, {
