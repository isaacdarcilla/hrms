		        ...
		        <div>
		          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
		            ...
		            <form class="w-full max-w-lg pr-4 pt-5">
			            ...
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
				            	<label class="form-label font-bold">Residential Block Address</label>
							    <input autofocus="true" class="form-input block w-full" placeholder="Enter residential block address" v-model="form.residential_block"
							    />
							    <div v-if="$page.errors.residential_block !== null" class="form-error">{{ $page.errors.residential_block }}</div>
							</div>
			            </div>
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
				            	<label class="form-label font-bold">Residential Street Address</label>
							    <input autofocus="true" class="form-input block w-full" placeholder="Enter residential street address" v-model="form.residential_street"
							    />
							    <div v-if="$page.errors.residential_street !== null" class="form-error">{{ $page.errors.residential_street }}</div>
							</div>
			            </div>
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
				            	<label class="form-label font-bold">Residential Village/Subdivision Address <span class="font-medium">(Optional)</span></label>
							    <input autofocus="true" class="form-input block w-full" placeholder="Enter residential village or subdivision address" v-model="form.residential_village"
							    />
							    <div v-if="$page.errors.residential_village !== null" class="form-error">{{ $page.errors.residential_village }}</div>
							</div>
			            </div>
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
				            	<label class="form-label font-bold">Residential Barangay Address</label>
							    <input autofocus="true" class="form-input block w-full" placeholder="Enter residential barangay address" v-model="form.residential_barangay"
							    />
							    <div v-if="$page.errors.residential_barangay !== null" class="form-error">{{ $page.errors.residential_barangay }}</div>
							</div>
			            </div>
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
				            	<label class="form-label font-bold">Residential Municipality Address</label>
							    <input autofocus="true" class="form-input block w-full" placeholder="Enter residential city or municipality address" v-model="form.residential_city"
							    />
							    <div v-if="$page.errors.residential_city !== null" class="form-error">{{ $page.errors.residential_city }}</div>
							</div>
			            </div>
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
				            	<label class="form-label font-bold">Residential Province Address</label>
							    <input autofocus="true" class="form-input block w-full" placeholder="Enter residential province address" v-model="form.residential_province"
							    />
							    <div v-if="$page.errors.residential_province !== null" class="form-error">{{ $page.errors.residential_province }}</div>
							</div>
			            </div>
			            <div class="flex flex-wrap -mx-3 mb-6">
	    					<div class="w-full px-3">
				            	<label class="form-label font-bold">Residential Zip Code Address</label>
							    <input autofocus="true" class="form-input block w-full" placeholder="Enter residential zip code address" v-model="form.residential_zipcode"
							    />
							    <div v-if="$page.errors.residential_zipcode !== null" class="form-error">{{ $page.errors.residential_zipcode }}</div>
							</div>
			            </div>
			            ...
			            <div v-if="!checked">
				            <div class="flex flex-wrap -mx-3 mb-6">
		    					<div class="w-full px-3">
					            	<label class="form-label font-bold">Permanent Block Address</label>
								    <input autofocus="true" class="form-input block w-full" placeholder="Enter permanent block address" v-model="form.permanent_block"
								    />
								    <div v-if="$page.errors.permanent_block !== null" class="form-error">{{ $page.errors.permanent_block }}</div>
								</div>
				            </div>
				            <div class="flex flex-wrap -mx-3 mb-6">
		    					<div class="w-full px-3">
					            	<label class="form-label font-bold">Permanent Street Address</label>
								    <input autofocus="true" class="form-input block w-full" placeholder="Enter permanent street address" v-model="form.permanent_street"
								    />
								    <div v-if="$page.errors.permanent_street !== null" class="form-error">{{ $page.errors.permanent_street }}</div>
								</div>
				            </div>
				            <div class="flex flex-wrap -mx-3 mb-6">
		    					<div class="w-full px-3">
					            	<label class="form-label font-bold">Permanent Village/Subdivision Address <span class="font-medium">(Optional)</span></label>
								    <input autofocus="true" class="form-input block w-full" placeholder="Enter permanent village or subdivision address" v-model="form.permanent_village"
								    />
								    <div v-if="$page.errors.permanent_village !== null" class="form-error">{{ $page.errors.permanent_village }}</div>
								</div>
				            </div>
				            <div class="flex flex-wrap -mx-3 mb-6">
		    					<div class="w-full px-3">
					            	<label class="form-label font-bold">Permanent Barangay Address</label>
								    <input autofocus="true" class="form-input block w-full" placeholder="Enter permanent barangay address" v-model="form.permanent_barangay"
								    />
								    <div v-if="$page.errors.permanent_barangay !== null" class="form-error">{{ $page.errors.permanent_barangay }}</div>
								</div>
				            </div>
				            <div class="flex flex-wrap -mx-3 mb-6">
		    					<div class="w-full px-3">
					            	<label class="form-label font-bold">Permanent Municipality Address</label>
								    <input autofocus="true" class="form-input block w-full" placeholder="Enter permanent city or municipality address" v-model="form.permanent_city"
								    />
								    <div v-if="$page.errors.permanent_city !== null" class="form-error">{{ $page.errors.permanent_city }}</div>
								</div>
				            </div>
				            <div class="flex flex-wrap -mx-3 mb-6">
		    					<div class="w-full px-3">
					            	<label class="form-label font-bold">Permanent Province Address</label>
								    <input autofocus="true" class="form-input block w-full" placeholder="Enter permanent province address" v-model="form.permanent_province"
								    />
								    <div v-if="$page.errors.permanent_province !== null" class="form-error">{{ $page.errors.permanent_province }}</div>
								</div>
				            </div>
				            <div class="flex flex-wrap -mx-3 mb-6">
		    					<div class="w-full px-3">
					            	<label class="form-label font-bold">Permanent Zip Code Address</label>
								    <input autofocus="true" class="form-input block w-full" placeholder="Enter permanent zip code address" v-model="form.permanent_zipcode"
								    />
								    <div v-if="$page.errors.permanent_zipcode !== null" class="form-error">{{ $page.errors.permanent_zipcode }}</div>
								</div>
				            </div>
			            </div>
			            <label class="mt-3 mb-3 select-none flex items-center" for="remember">
				            <input ref="residential" id="res" v-model="checked" v-bind="$attrs" type="checkbox" class="mr-1 focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
				            <span class="text-sm font-medium" for="res">Residential address is the same as permanent address?</span>
			            </label>
			        </form>
		          </div>
		        </div>
	...
	methods: {
		address(checked) {
			if(checked === true) {
                ...
                this.form.permanent_village = this.form.residential_village;
                this.form.permanent_street = this.form.residential_street;
                this.form.permanent_barangay = this.form.residential_barangay;
