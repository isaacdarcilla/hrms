            ...
            <div>
              <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                <h3
                  ...
                  id="modal-headline"
                >
                  ✏️ Edit {{ employeeId.first_name }} Character References
                </h3>
                <form @submit.prevent="save" class="w-full max-w-lg pr-4 pt-5">
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      <label class="form-label font-bold">Address <span class="text-red-600">*</span></label>
                      <input
                        autofocus="true"
                        class="form-input block w-full"
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      <label class="form-label font-bold">Telephone Number <span class="text-red-600">*</span></label>
                      <input
                        autofocus="true"
                        class="form-input block w-full"
                        :placeholder="reference.telephone_number"
                        v-model="form.telephone_number"
                      />
                      <div
                        v-if="$page.errors.telephone_number !== null"
                        class="form-error"
                      >
                        {{ $page.errors.telephone_number }}
                      </div>
                    </div>
                  </div>
                </form>
...
export default {
  ...
  methods: {
    save() {
      this.$inertia.put(
        this.route("reference.update", this.reference.id),
        this.form,
        {
