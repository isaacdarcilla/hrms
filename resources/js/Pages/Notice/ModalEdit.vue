                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        ...
                        :placeholder="notice.notice_type"
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <input
                        autofocus="true"
                        class="form-input block w-full"
                        :placeholder="notice.notice_subject"
                  ...
                  <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                      ...
                      <textarea
                        ...
                        autofocus="true"
                        class="form-input block w-full"
                        :placeholder="notice.notice_description"
...
export default {
  ...
  methods: {
    save() {
      this.$inertia.put(this.route("notices.update", this.notice.id), this.form, {
