<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">
      ...
      Application of {{ scholar.contact.first_name }}
    ...
    <div class="bg-white rounded shadow overflow-hidden">
      <form @submit.prevent="submit">
        ...
        <div v-if="scholar.scholarship_type == '3'" class="flex-row mx-10 mb-6">
          <div class="my-5 text-blue-600 font-semibold">
            Uploaded Document Requirements
          </div>
          <div class="flex flex-wrap">
        ...
        <!-- Abroad -->
        <div v-if="scholar.scholarship_type == '2'" class="flex-row mx-10 mb-6">
          <div class="my-5 text-blue-600 font-semibold">
            Uploaded Document Requirements
          </div>
          <div class="flex flex-wrap">
        ...
        >
          ...
          <div class="flex flex-wrap">
            ...
            <div class="px-2 w-6/12 sm:w-4/12">
              <div class="flex justify-between">
                <div class="my-2 font-semibold text-sm">
                  Certification that the employee did not previously enjoy
                  scholarship grant
                </div>
                <div
                  @click="image('doc13')"
