<template>
  <div>
    <h1 class="mb-8 font-bold text-3xl">Inquiries 🎫</h1>
    ...
    <create-modal :showing="showCreate" :employee="employee" :modal.sync="showCreate"></create-modal>
