    ...
    <div class="flex">
      <div class="w-3/12 border-b-2 border-black bg-gray-300">
        <div class="flex h-8 border-b-2 border-black">
          ...
          <div class="my-auto text-xxs font-normal text-black">BLOOD TYPE</div>
        </div>
        <div class="flex h-8">
          <div class="my-auto text-xxs font-normal text-black pr-2 p-1">
            10.
          </div>
          <div class="my-auto text-xxs font-normal text-black">GSIS ID NO.</div>
        </div>
      </div>
    ...
    <div class="flex">
      <div class="w-3/12 border-b-2 border-black bg-gray-300">
        ...
        <div class="flex h-6 border-b-2 border-black">
          ...
          <div class="my-auto text-xxs font-normal text-black">TIN NO.</div>
        </div>
        <div class="flex h-6">
          <div class="my-auto text-xxs font-normal text-black pr-2 p-1">
            15.
