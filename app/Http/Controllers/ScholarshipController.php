...
class ScholarshipController extends Controller
{
    ...
    public function store() {
        ...
        Request::validate([
            ...
            'school_last_attended' => 'required|min:4',
            'school_address' => 'required|min:4',
            'degree_program' => 'required|min:4',
            ...
            'degree_name' => $scholarship == '4' ? 'required|min:4' : 'nullable',
            'plan' => $scholarship == '4' ? 'required' : 'nullable',
            'grantee_agency' => $plan == '1' ? 'required|min:4' : 'nullable',
            'school_intended_to_enroll' => $plan == '1' || $plan == '2' ? 'required|min:4' : 'nullable',
            'intended_school_address' => $plan == '1' || $plan == '2' ? 'required|min:4' : 'nullable',
            ...
            'thesis_or_dissertation' => $plan == '4' ? 'required|min:4' : 'nullable',
            'thesis_or_dissertation_name' => $plan == '4' ? 'required|min:4' : 'nullable',
            'recipient_before' => 'required',
            'sponsoring_agency_before' => $before == 'Yes' ? 'required|min:4' : 'nullable',
